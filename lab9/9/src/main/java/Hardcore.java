...
public class Hardcore {
    public static void main(String[] args) throws InterruptedException {
         ...
         * driver.findElement((By.xpath("//div[@class='devsite-search-container']"))).
         * click();
         * WebElement Search = driver.findElement(By.
         * xpath("//input[@class='devsite-search-field devsite-search-query']"));
         * Search.click();
         * Search.sendKeys("Google Cloud Pricing Calculator");
         * Search.sendKeys(Keys.ENTER);
         * Thread.sleep(10000);
         * driver.findElement(By.
         * xpath("//b[text()='Google Cloud Pricing Calculator']/parent::a")).click();
         * Thread.sleep(10000);
         */
        ...
        WebElement numberOfInstancesField = driver.findElement(
        ...
        /*
         * driver.findElement(By.xpath("//md-select[@placeholder='Datacenter location']"
         * )).click();
